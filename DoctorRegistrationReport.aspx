<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DoctorRegistrationReport.aspx.cs" Inherits="TelemedicsAdminWebApp.DoctorRegistrationReport" %>
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="min-height:600px;">
    ...
    <section class="content-header">
      <h1> <span><em class="fa fa-university"></em></span>	Doctor Registration Report   </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.aspx"><i class="fa fa-home"></i> Home</a></li>
        <li class="active">Doctor Registration Report</li>
      </ol>
    </section>
                ...
                <div class="panel panel-container">
                    <div class="table-responsive">                       
			            <asp:GridView ID="gvRegistrationSummary" width="100%"  runat="server" AutoGenerateColumns="False" 
                            DataKeyNames="DoctorId" AllowSorting="True" PageSize="20" AllowPaging="False" 
